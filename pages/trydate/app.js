...
(async function init() {
  try {
    // This call, not the page request, is what counts as an open. TOKEN comes
    // from the URL that was opened, so a `-test` suffix rides along and the
    // server knows the open was yours.
